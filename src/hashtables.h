...
inline
  ...
  static unsigned char asso_values[] = {
      ...
      39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39,
      39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39,
      39, 39, 39, 39, 39, 39, 39, 5,  10, 39, 0,  15, 39, 25, 39, 8,  0,  39,
      10, 3,  5,  25, 39, 39, 0,  0,  39, 0,  39, 0,  0,  39, 39, 39, 39, 39,
      39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39,
      39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39,
      39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39,
      39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39,
...
struct OpCodeMap *encontra_operacao(register const char *str,
                                    register size_t len) {
  enum {
  ...
  static struct OpCodeMap operacoes[] = {
#line 30 "opcodehash"
      {"j", 0x0D, J},
#line 32 "opcodehash"
      {"sw", 0x0F, I},
  ...
  if (len <= OP_MAX_WORD_LENGTH && len >= OP_MIN_WORD_LENGTH) {
    ...
    if (key <= OP_MAX_HASH_VALUE && key >= OP_MIN_HASH_VALUE) {
      ...
      case 12:
        ...
        goto compare;
      case 17:
        resword = &operacoes[10];
        goto compare;
      case 18:
        resword = &operacoes[11];
        goto compare;
      case 22:
        resword = &operacoes[12];
        goto compare;
      case 26:
        resword = &operacoes[13];
        goto compare;
      case 27:
        resword = &operacoes[14];
        goto compare;
      case 32:
        resword = &operacoes[15];
        goto compare;
      case 37:
        resword = &operacoes[16];
        goto compare;
      }
      return 0;
    compare : {
  ...
  if (len <= REG_MAX_WORD_LENGTH && len >= REG_MIN_WORD_LENGTH) {
    ...
    if (key <= REG_MAX_HASH_VALUE && key >= REG_MIN_HASH_VALUE) {
      ...
      case 15:
        ...
        goto compare;
      case 16:
        resword = &reg_array[10];
        goto compare;
      case 17:
        resword = &reg_array[11];
        goto compare;
      case 18:
        resword = &reg_array[12];
        goto compare;
      case 21:
        resword = &reg_array[13];
        goto compare;
      case 22:
        resword = &reg_array[14];
        goto compare;
      case 25:
        resword = &reg_array[15];
        goto compare;
      case 26:
        resword = &reg_array[16];
        goto compare;
      case 27:
        resword = &reg_array[17];
        goto compare;
      case 31:
        resword = &reg_array[18];
        goto compare;
      case 32:
        resword = &reg_array[19];
        goto compare;
      case 36:
        resword = &reg_array[20];
        goto compare;
      case 37:
        resword = &reg_array[21];
        goto compare;
      case 40:
        resword = &reg_array[22];
        goto compare;
      case 41:
        resword = &reg_array[23];
        goto compare;
      case 42:
        resword = &reg_array[24];
        goto compare;
      case 46:
        resword = &reg_array[25];
        goto compare;
      case 50:
        resword = &reg_array[26];
        goto compare;
      case 51:
        resword = &reg_array[27];
        goto compare;
      case 56:
        resword = &reg_array[28];
        goto compare;
      case 60:
        resword = &reg_array[29];
        goto compare;
      case 61:
        resword = &reg_array[30];
        goto compare;
      case 66:
        resword = &reg_array[31];
        goto compare;
      }
      return 0;
    compare : {
